...
import { calculateCoefficients, getCoefficientForDate, getTidesForDate, coeffLabel, coeffClass } from '../utils/tidesApi'
import { getDailyForDate } from '../utils/weatherApi'
import {
  getCoeffCategory, getPressureTrend,
  findSimilarDays,
  TREND_LABELS, TOD_LABELS,
...
export default function FishingCalendar({ weather, tides, onDateSelect }) {
  ...
  const saveFavorite = (originalDate, payload) => {
    saveFavoriteSession(originalDate, payload, { upsert, remove })
  }
